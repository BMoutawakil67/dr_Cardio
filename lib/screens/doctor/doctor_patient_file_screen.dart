...
class _DoctorPatientFileScreenState extends State<DoctorPatientFileScreen> {
  ...
  void _addNote(BuildContext context, {MedicalNote? note}) {
    ...
    String _selectedCategory = note?.category ?? 'consultation';

    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(
            note == null ? 'Ajouter une note médicale' : 'Modifier la note'),
        content: Form(
          key: _formKey,
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['consultation', 'traitement', 'urgence', 'autre']
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                final newNote = MedicalNote(
                  ...
                  doctorName: 'Dr. Dubois', // Example doctor name
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  '${note.date.day}/${note.date.month}/${note.date.year} - ${note.doctorName}',
                  style:
